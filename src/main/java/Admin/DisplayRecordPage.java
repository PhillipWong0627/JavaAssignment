 ...
 * @author user
 */
public class DisplayRecordPage extends javax.swing.JFrame {

    /**
     * Creates new form DisplayRecordPage
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DISPLAY SPECIFIC RECORD");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayRecordPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisplayRecordPage().setVisible(true);
            }
        });
    }
