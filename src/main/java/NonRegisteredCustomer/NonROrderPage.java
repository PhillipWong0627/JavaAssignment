 ...
 * @author Kenny
 */
public class NonROrderPage extends javax.swing.JFrame {


    NonRegistered nr =new NonRegistered();
    
    /**
     * Creates new form RegisterPage
     */
    public NonROrderPage() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Register By Pressing Here!!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NonROrderPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NonROrderPage().setVisible(true);
            }
        });
    }
