 ...
 * @author Kenny
 */
public class CustomerRegisterTesting extends javax.swing.JFrame {
     ...
     */
    public CustomerRegisterTesting() {
        initComponents();
    }
...
//     AddData(username.getText(),password.getText(),email.getText(),dateofbirth.getText(),phonenumber.getText(),address.getText(),creditcardnumber.getText(),nameofcreditcard.getText());  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerRegisterTesting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerRegisterTesting().setVisible(true);
            }
        });
    }
