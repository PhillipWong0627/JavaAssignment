 ...
 * @author Kenny
 */
public class CustomerLoginDupl extends javax.swing.JFrame {

    /**
     * Creates new form CustomerLogin
     */
    public CustomerLoginDupl() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerLoginDupl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerLoginDupl().setVisible(true);
            }
        });
    }
