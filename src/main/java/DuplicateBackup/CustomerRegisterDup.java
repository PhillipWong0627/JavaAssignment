 ...
 * @author Kenny
 */
public class CustomerRegisterDup extends javax.swing.JFrame {

    /**
     * Creates new form RegisterPage
     */
    public CustomerRegisterDup() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerRegisterDup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerRegisterDup().setVisible(true);
            }
        });
    }
